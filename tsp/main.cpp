...
public:
    ...
    T_path (T_matr const &dist_matr): dist_matr_(dist_matr),shortest_path_len_(std::numeric_limits< T_dist >::max()) //numeric_limits - максимально возможное значение T_dist
    {
